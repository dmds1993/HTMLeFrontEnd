...
<html>
   <head>
	<meta charset ="UTF8">
	        ...
	        <img src ="img/logo.png" alt="Foto Logo Mirror">
                   <h1>A Mirror Fashion</h1>
	             <link href ="css/sobre.css"rel="stylesheet"type="text/css"/>
	               <p>A <b>Mirror Fashion</b> é a maior empresa comércio eletrônico no segmento de moda em todo o mundo. Fundada em 1932 com <?php print date ('Y') - 1932 ?> anos de tradição,possui filiais em 124 países, sendo líder de mercado com mais de 90% de participação em 118 deles.</p>
	               <p> Nosso centro de distribuição fica em <a href="https://maps.google.com.br/?q=Jacarezinho">Jacarezinho, no Paraná</a>. De lá, saem 48 aviões que distribuem nossos produtos às casas do mundo todo. Nosso centro de distribuição:</p>
	                  <figure id="centro-distribuicao">
	                       <img src ="img/centro-distribuicao.png"alt="Foto Centro Mirror">
	                        <fitcaption><p>Centro de Distribuição Mirror Fashion</p></figcaption>
	                  </figure>
	    <p>Compre suas roupas e acessórios na <strong>Mirror Fashion</strong>. <a href="/home/daniel/Desktop/mirrorfashion/index.html">Acesse nossa</a> loja ou entre em contato se tiver dúvidas. Conheça também nossa <a href="#historia">história</a> e nossos<a href="#diferenciais"> diferenciais</a>.</p>

             <h2 id="historia">História</h2>
		     <figure id="familia-pelho">
			<img src="img/familia-pelho.jpg"alt="Foto familia pelho">
	              <fitcaption><p>Família Pelho</p></figcaption>
                    </figure>
...
Brasil, mas mesmo após apenas 5 anos de sua existência, já possuía 30 mil funcionários. Fora do Brasil, há 240 mil funcionários, além dos 890 mil brasileiros nas instalações de Jacarezinho e nos escritórios em todo país.</p>
